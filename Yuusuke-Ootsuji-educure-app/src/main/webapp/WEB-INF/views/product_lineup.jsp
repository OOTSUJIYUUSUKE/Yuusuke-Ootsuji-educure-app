...
<title>AgriConnect. 商品一覧画面</title>
<link rel="stylesheet" href="css/product_lineup.css">
</head>
<body>
	<div class="container">
		<header class="header">
		...
		<main>
			...
			<div class="product-list" id="product-list">
				<c:forEach items="${products}" var="product">
					<a href="${pageContext.request.contextPath}/product_detail?product_id=${product.productId}" class="product-link">
